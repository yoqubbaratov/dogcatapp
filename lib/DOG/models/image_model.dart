...
List<Imagew> imageListFromJson(String str) {
  List list = jsonDecode(str);
  List<Imagew> images = list.map((e) => Imagew.fromJson(e)).toList();
  return images;
}

Imagew imageFromJson(String str) => Imagew.fromJson(json.decode(str));
String imageToJson(Imagew data) => json.encode(data.toJson());
